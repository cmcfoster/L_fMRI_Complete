...
set out_file = "${base_dir}/group_analyses/nback/results.nii.gz"
set out_file_residual = "${base_dir}/group_analyses/nback/results_residual.nii.gz"
set data_table = "${base_dir}/group_analyses/nback/in_data_table.txt"
