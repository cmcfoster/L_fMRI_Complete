function [] = segment_brain(anat, spm_path, overwrite)
%segment_brain segment t1 into different tissue types
%   Uses probability maps (TPM.nii) from SPM12 and segments the T1 into:
%   gm, wm, csf, bone, soft tissue, and air/background
%
%   input:
%       anat      full path to anat nifti
...
save(correct_path([fileparts(anat) '\segment_T1_Batch.mat']), 'matlabbatch');
