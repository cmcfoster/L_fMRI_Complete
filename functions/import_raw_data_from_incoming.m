function [] = import_raw_data_from_incoming(base_path, long_dir, subj, log_path)
...
subj_dir = [ strrep(base_path,'/KK_KR_JLBS','') 'incoming/nii/' subj];   %CMF added base path to this function.      						% raw folder
